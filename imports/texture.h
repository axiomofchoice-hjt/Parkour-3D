#ifndef Parkour_imports_texture
#define Parkour_imports_texture

const int BMP_Header_Length = 54;

bool power_of_two(uint n) { return (n & (n - 1)) == 0; }

int load_texture(const char* file_name) {
